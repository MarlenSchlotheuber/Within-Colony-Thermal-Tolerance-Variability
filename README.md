...
2. the R-script contains the script that was used to analyse the data and to create figures for the manuscript can be found. Figures were finalized using Affinity Designer.

##### Note
- Raw FASTQ sequencing files of the 16S and ITS2 data are accessible at NCBI under BioProject: PRJNA1419122
- Images of the visual bleaching assessment data can be found on Zenodo (remove if VBA data removed)
